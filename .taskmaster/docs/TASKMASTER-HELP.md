# Task Master CLI - Help (Captured)

This file captures the full help output for quick reference offline.

Run command: `task-master help`
Captured on: 2025-08-10T22:32:15Z
...
Commands:
  ...
  scope-up [options]               Increase task complexity with AI assistance
  scope-down [options]             Decrease task complexity with AI assistance
  ...
  rules [options]                  Add or remove rules for one or more profiles. Valid actions: add, remove (e.g., task-master rules add windsurf roo)
...
╰───────────────────╯
    ...
    set-status                             --id=<id> --status=<status>                                         Update task status (pending, done, in-progress, review, deferred,        
                                                                                                               cancelled)                                                               
...
╰─────────────────────────────╯
    ...
    research                               "<prompt>" [-i=<task_ids>] [-f=<file_paths>] [-c="<context>"]       Perform AI-powered research queries with project context                 
                                           [--tree] [-s=<save_file>] [-d=<detail_level>]                                                                                                
...
╰──────────────────╯
    ...
    add-tag                                <tagName> [--copy-from-current] [--copy-from=<tag>]                 Create a new tag context for organizing tasks                            
                                           [-d="<desc>"]                                                                                                                                
